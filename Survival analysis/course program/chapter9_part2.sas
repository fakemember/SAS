...
proc phreg data= mydata2;
  model d_free_t*d_free_i(0) = group2 group3 FAB_i z_age_p z_age_d  z_age_p*z_age_d z_p;
...
/*** table 9.9  ***/
proc phreg data=mydata2;
   model d_free_t*d_free_i(0) = group2 group3 FAB_i z_age_p z_age_d  z_age_p*z_age_d /entry=plate_t;
   strata mtx_i;
run;
