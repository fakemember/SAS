...
Z5--Burn site indicator: head 
      1=yes, 0=no 
Z6--Burn site indicator: buttock 
      1=yes, 0=no 
Z7--Burn site indicator: trunk 
      1=yes, 0=no 
Z8--Burn site indicator: upper leg 
      1=yes, 0=no 
Z9--Burn site indicator: lower leg 
      1=yes, 0=no 
Z10--Burn site indicator: respiratory tract 
      1=yes, 0=no 
Z11--Type of burn 
      1=chemical, 2=scald, 3=electric, 4=flame 
T1--Time to excision or on study time 
1 --Excision indicator 
      1=yes 0=no 
...
3 --Straphylocous aureaus infection 
      1=yes 0=no 
Reference Ichida et al. Stat. Med. 12 (1993): 301-310.
*/

data hw8_9;
input subjid trt gender race percent site_h site_b site_t site_u site_l site_r burntype e_time e_indic p_time p_indic s_time s_indic;
cards;
...
/** (a)  **/
   proc phreg data=hw8_9 ;
      model s_time*s_indic(0)= trt / ties=breslow;
   run;


/** (b)  **/
   proc phreg data=hw8_9 ;
      model s_time*s_indic(0)= percent trt / ties=breslow;
   run;

/** (c)  **/
   proc phreg data=hw8_9 ;
      model s_time*s_indic(0)= gender  trt / ties=breslow;
   run;
  proc phreg data=hw8_9 ;
      model s_time*s_indic(0)= race  trt / ties=breslow;
   run;
  proc phreg data=hw8_9 ;
      model s_time*s_indic(0)= percent trt / ties=breslow;
   run;
  proc phreg data=hw8_9 ;
  class burntype;
      model s_time*s_indic(0)=  burntype trt / ties=breslow;
   run;

/** (d) **/
  proc phreg data=hw8_9 ;
  class burntype / ref=first;
      model s_time*s_indic(0)= gender race percent burntype trt / ties=breslow selection=forward;
   run;
